        ...
        <div style={sideListStyle}>
            ...
            <div style={sideListContentContainerStyle} className="scrollbar">
                ...
                <div style={bestOfYoutubeContainerStyle}>
                    ...
                    <div style={bestOfYoutubeIconContainerStyle} className="hovered"><img style={bestOfYoutubeIconStyle} alt='logo' src={musicIcon} /> <span style={bestOfYoutubeTitleStyle}>Music</span></div>
                    <div style={bestOfYoutubeIconContainerStyle} className="hovered"><img style={bestOfYoutubeIconStyle} alt='logo' src={soccerIcon} /> <span style={bestOfYoutubeTitleStyle}>Sports</span></div>
                    <div style={bestOfYoutubeIconContainerStyle} className="hovered"><img style={bestOfYoutubeIconStyle} alt='logo' src={gamingIcon} /> <span style={bestOfYoutubeTitleStyle}>Gaming</span></div>
                    <div style={bestOfYoutubeIconContainerStyle} className="hovered"><img style={bestOfYoutubeIconStyle} alt='logo' src={filmIcon} /> <span style={bestOfYoutubeTitleStyle}>Movies</span></div>
                    <div style={bestOfYoutubeIconContainerStyle} className="hovered"><img style={bestOfYoutubeIconStyle} alt='logo' src={filmIcon} /> <span style={bestOfYoutubeTitleStyle}>TV Shows</span></div>
                    <div style={bestOfYoutubeIconContainerStyle} className="hovered"><img style={bestOfYoutubeIconStyle} alt='logo' src={newsIcon} /> <span style={bestOfYoutubeTitleStyle}>News</span></div>
                    <div style={bestOfYoutubeIconContainerStyle} className="hovered"><img style={bestOfYoutubeIconStyle} alt='logo' src={liveIcon} /> <span style={bestOfYoutubeTitleStyle}>Live</span></div>
                    <div style={bestOfYoutubeIconContainerStyle} className="hovered"><img style={bestOfYoutubeIconStyle} alt='logo' src={spotlightIcon} /> <span style={bestOfYoutubeTitleStyle}>Spotlight</span></div>
                    <div style={bestOfYoutubeIconContainerStyle} className="hovered"><img style={bestOfYoutubeIconStyle} alt='logo' src={videoIcon} /> <span style={bestOfYoutubeTitleStyle}>360° Video</span></div>
                </div>
                <div style={browseChannelContainerStyle}>
                    <div style={browseChannelStyle} className="hovered"><img style={browsePlusStyle} alt='logo' src={plusIcon} /><span style={browseChannelTitleStyle}>Browse channels</span></div>
                </div>
                <div style={bestOfYoutubeContainerStyle}>
